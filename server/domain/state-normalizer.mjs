...
export function normalizeState(state) {
  ...
  const placeNodes = safeArray(state.placeNodes).map(normalizePlaceCountry);
...
function normalizePlaceCountry(place) {
  const inferred = !place.country && isUsableLocation(place.center) ? reverseLocalGeocode(place.center, { preferCity: true })[0] : undefined;
